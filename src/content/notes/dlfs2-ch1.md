...
description: "Deep Learning from Scratch 2 스터디 노트, 1장 신경망 복습"
date: 2023-08-12
...
![벡터와 행렬의 예](/images/notes/2023/scratch2/ch1/fig-1-1.png)
...
![신경망의 예](/images/notes/2023/scratch2/ch1/fig-1-7.png)
...
- 모든 계층은 forward() _(순전파)

* 와 backward() *(역전파)_ 메서드를 가진다.
...
학습 단계의 특정 시점에서 신경망의 성능을 나타내는 척도로 손실(loss)을 사용합니다. 손실은 학습 데이터와 신경망 예측 결과를 비교하여 예측이 얼마나 나쁜가를 나타내는 스칼라값입니다.
